    ...
    <div class="col-md-6 col-lg-3 col-xl-3">
      ...
      >
        <template #info>
          ...
          <h4>
            What if your node is validating, but stellarobserver labels it as not
            validating?
          </h4>
          <ul>
            <li>
              Stellarobserver detects nodes validating in a specific crawl/time
              window. It could be the validator is too slow for this window, or
              catching up.
            </li>
            <li>
              If stellarobserver cannot connect to the node because it is at max
              capacity and the node is not trusted by other nodes, stellarobserver
      ...
      >
        <template #info>
          ...
          <p class="my-4">
            ...
            To mitigate this, stellarobserver filters out 'badly configured' nodes.
